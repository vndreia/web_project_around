...
const popupButton = document.querySelector('.action-bar__button-type-form');
...
const editName = document.querySelector('.action-bar__title');
console.log(editName);
const editJob = document.querySelector('.action-bar__paragraph');
console.log(editJob);
//Manipulation
